                            ...
                            <table className="min-w-full divide-y divide-gray-200">
                                <thead className="bg-gray-50">
                                    <tr>
                                        ...
                                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Uang Masuk</th>
                                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">SPP / Bulan</th>
                                    ...
                                    {programs.map((program) => (
                                        <tr key={program.id}>
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <div className="text-sm font-bold text-gray-900">{program.nama}</div>
                                                <div className="text-xs text-gray-500">{program.jenis}</div>
                                                {program.featured ? <span className="text-[10px] text-green-600 font-bold bg-green-100 px-2 py-0.5 rounded">Featured</span> : ''}
                                            </td>
