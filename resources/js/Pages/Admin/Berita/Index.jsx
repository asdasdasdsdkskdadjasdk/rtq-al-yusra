        ...
        <AuthenticatedLayout auth={auth}>
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <Link
                    ...
                    className="bg-orange-600 text-white px-4 py-2 rounded-md hover:bg-orange-700 shadow"
                >
                    + Tambah Berita
                </Link>
            </div>
            ...
            {flash.success && (
                <div className="mb-4 p-4 bg-orange-100 text-orange-700 rounded-lg border border-orange-400">
                    {flash.success}
                </div>
            )}
