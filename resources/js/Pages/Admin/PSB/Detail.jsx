            ...
            <div className="mt-2">
                ...
                {isImage ? (
                    <div className="border p-1 rounded-lg w-fit">
                        ...
                        <a href={fileUrl} target="_blank" className="text-xs text-blue-600 hover:underline mt-1 block">Lihat Full</a>
                    </div>
                ) : (
                    <a 
                        href={fileUrl} 
                        target="_blank" 
                        className="flex items-center gap-2 px-4 py-2 bg-gray-100 rounded-lg text-blue-600 hover:bg-gray-200 transition"
                    >
                ...
                <div className="bg-white shadow-xl rounded-2xl overflow-hidden">
                    ...
                    <div className="bg-gray-50 p-6 border-b flex justify-between items-start">
                        <div>
                            ...
                            <span className={`mt-3 inline-block px-3 py-1 text-xs font-bold rounded-full ${
                                pendaftar.status === 'Lulus' ? 'bg-green-100 text-green-700' :
                        ...
                        <Link 
                            ...
                            className="px-4 py-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition shadow"
                        >
                            Edit Formulir
                        </Link>
                    </div>
