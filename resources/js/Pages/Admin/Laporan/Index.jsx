                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        ...
                                        {/* Card SPP */}
                                        <label className={`cursor-pointer border-2 rounded-xl p-4 flex flex-col items-center justify-center transition-all ${data.kategori === 'spp' ? 'border-orange-500 bg-orange-50' : 'border-gray-200 hover:border-orange-300'}`}>
                                            ...
                                            <span className={`font-bold ${data.kategori === 'spp' ? 'text-orange-700' : 'text-gray-600'}`}>Laporan SPP</span>
                                        </label>

                                        {/* Card Uang Masuk */}
                                        <label className={`cursor-pointer border-2 rounded-xl p-4 flex flex-col items-center justify-center transition-all ${data.kategori === 'uang_masuk' ? 'border-orange-500 bg-orange-50' : 'border-gray-200 hover:border-orange-300'}`}>
                                            ...
                                            <span className="text-3xl mb-2">💰</span>
                                            <span className={`font-bold ${data.kategori === 'uang_masuk' ? 'text-orange-700' : 'text-gray-600'}`}>Uang Masuk</span>
                                        </label>

                                        {/* Card Formulir */}
                                        <label className={`cursor-pointer border-2 rounded-xl p-4 flex flex-col items-center justify-center transition-all ${data.kategori === 'formulir' ? 'border-orange-500 bg-orange-50' : 'border-gray-200 hover:border-orange-300'}`}>
                                            ...
                                            <span className="text-3xl mb-2">📝</span>
                                            <span className={`font-bold ${data.kategori === 'formulir' ? 'text-orange-700' : 'text-gray-600'}`}>Data Formulir</span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div className="pt-4 flex justify-end border-t">
                                    <button
                                        type="submit"
                                        className="inline-flex items-center px-6 py-3 bg-orange-600 border border-transparent rounded-lg font-bold text-xs text-white uppercase tracking-widest hover:bg-orange-700 active:bg-orange-800 focus:outline-none focus:border-orange-800 focus:ring ring-orange-300 disabled:opacity-25 transition ease-in-out duration-150 gap-2"
                                    >
