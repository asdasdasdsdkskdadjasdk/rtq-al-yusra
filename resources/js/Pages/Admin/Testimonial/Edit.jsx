...
export default function Edit({ auth, testimonial }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        // Gunakan post dengan _method: PUT untuk upload file
        router.post(route('admin.testimonial.update', testimonial.id), data);
    };

    return (
        <AuthenticatedLayout auth={auth} header={<h2 className="font-semibold text-xl text-gray-800">Edit Testimoni</h2>}>
                        ...
                        <form onSubmit={submit} encType="multipart/form-data" className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <TextInput id="role" value={data.role} onChange={e => setData('role', e.target.value)} className="mt-1 block w-full" required />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <InputLabel htmlFor="avatar" value="Ganti Foto (Opsional)" />
                                    <input 
                                        id="avatar" 
                                        type="file" 
                            ...
                            <div className="flex items-center justify-end mt-4 pt-4 border-t">
                                ...
                                <PrimaryButton disabled={processing}>Update Testimoni</PrimaryButton>
                            </div>
