                                    ...
                                    <form onSubmit={submit} className="space-y-6">
                                        ...
                                        <div>
                                            ...
                                            <div 
                                                ...
                                                onDrop={handleDrop}
                                                className={`mt-1 flex justify-center px-6 pt-10 pb-10 border-2 border-dashed rounded-xl cursor-pointer transition-colors duration-200 ${
                                                    isDragActive 
                                        ...
                                        <div className="pt-4">
                                            <button
                                                type="submit"
                                                disabled={processing}
                                                className="w-full py-3 bg-orange-600 text-white font-bold rounded-xl hover:bg-orange-700 transition shadow-lg"
                                            >
