    ...
    const handlePay = async (e) => {
        ...
        try {
            const response = await fetch(route('wali.uang-masuk.pay'), {
                ...
                body: JSON.stringify({ jumlah_bayar: nominal })
            });
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-blue-600 relative overflow-hidden">
                    <div className="flex flex-col md:flex-row justify-between items-start mb-6 gap-4 relative z-10">
                        <div>
                            ...
                            <p className="text-gray-500 text-sm mt-1">Program: <span className="font-semibold text-blue-600">{tagihan.program_nama}</span></p>
                        ...
                        {tagihan.status_text !== 'Lunas' && (
                            <div className="flex gap-3 w-full md:w-auto">
                                <button 
                                    ...
                                    className="flex-1 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg font-bold shadow-md transition text-sm flex items-center justify-center gap-2"
                                >
                    ...
                    <div className="mt-8 relative z-10">
                        <div className="flex justify-between text-xs font-semibold mb-2">
                            <span className="text-blue-600">Progres Pembayaran</span>
                            <span className="text-gray-600">{persentase.toFixed(0)}%</span>
                        </div>
                        <div className="w-full bg-gray-200 rounded-full h-2.5 overflow-hidden">
                            <div className="bg-blue-600 h-2.5 rounded-full transition-all duration-1000 ease-out" style={{ width: `${persentase}%` }}></div>
                        </div>
                    </div>

                    {/* Dekorasi Background */}
                    <div className="absolute top-0 right-0 -mt-10 -mr-10 w-40 h-40 bg-blue-100 rounded-full opacity-50 blur-3xl"></div>
                </div>
                    ...
                    <form onSubmit={handlePay}>
                        <div className="mb-6">
                            ...
                            <div className="relative">
                                ...
                                <input 
                                    type="number"
                                    className="w-full pl-10 border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-sm"
                        ...
                        <div className="flex justify-end gap-3 pt-4 border-t">
                            ...
                            <button type="submit" disabled={loading} className="px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-bold hover:bg-blue-700 shadow-lg shadow-blue-200 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2">
                                {loading ? (
                                    <>
                    ...
                    <form onSubmit={handleUpload} className="space-y-5">
                        <div>
                            ...
                            <input 
                                ...
                                onChange={e => setUploadData('jumlah_bayar', e.target.value)}
